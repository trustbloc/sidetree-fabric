...
Feature:
  ...
  Scenario: Blockchain functions
    ...
    When an HTTP GET is sent to "https://localhost:48326/sidetree/v1/cas/${core_index_uri_9}?max-size=1000000"
    ...
    When an HTTP GET is sent to "https://localhost:48326/sidetree/v1/cas/${mapFileURI}?max-size=1000000"
    And response is decompressed using "GZIP"
    ...
    When an HTTP GET is sent to "https://localhost:48326/sidetree/v1/cas/${url-encoded-core-index-uri}?max-size=1000000"
    And response is decompressed using "GZIP"
