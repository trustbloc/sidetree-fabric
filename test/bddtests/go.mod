...
require (
	...
	github.com/trustbloc/fabric-peer-test-common v0.1.5-0.20200924170026-94a1825995eb
	github.com/trustbloc/sidetree-core-go v0.1.5-0.20201001155545-5f66ab09f47e
)
