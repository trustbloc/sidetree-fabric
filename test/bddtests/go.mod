...
require (
	...
	github.com/trustbloc/fabric-peer-test-common v0.1.3-0.20200501210457-ed0192c1e0c0
	github.com/trustbloc/sidetree-core-go v0.1.3-0.20200430203822-5e12db11f149
)
