...
require (
	...
	github.com/trustbloc/fabric-peer-test-common v0.1.3-0.20200421214645-4ca6334281df
	github.com/trustbloc/sidetree-core-go v0.1.3-0.20200423152739-44fc61387368
)
