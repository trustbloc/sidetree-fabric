...
type DCASClientProvider struct {
	ForChannelStub        func(channelID string) (dcas.DCAS, error)
...
func (fake *DCASClientProvider) ForChannel(channelID string) (dcas.DCAS, error) {
...
func (fake *DCASClientProvider) ForChannelReturns(result1 dcas.DCAS, result2 error) {
...
func (fake *DCASClientProvider) ForChannelReturnsOnCall(i int, result1 dcas.DCAS, result2 error) {
	fake.ForChannelStub = nil
