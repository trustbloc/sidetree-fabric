...
type BatchWriter struct {
	AddStub        func(operation []byte) error
...
func (fake *BatchWriter) Add(operation []byte) error {
	var operationCopy []byte
	if operation != nil {
		operationCopy = make([]byte, len(operation))
		copy(operationCopy, operation)
	}
	fake.addMutex.Lock()
	...
	fake.recordInvocation("Add", []interface{}{operationCopy})
...
func (fake *BatchWriter) AddArgsForCall(i int) []byte {
	fake.addMutex.RLock()
	defer fake.addMutex.RUnlock()
